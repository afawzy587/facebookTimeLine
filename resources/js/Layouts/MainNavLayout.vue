    ...
    <div class="flex items-center justify-end w-2/12 mr-4">
        ...
        <div class="flex items-center justify-center relative">
            <button @click="showMenu = !showMenu">
                <img class="rounded-full ml-1 min-w-[40px] max-h-[40px] cursor-pointer" src="https://picsum.photos/id/140/300/320">
            </button>
            <div
                v-if="showMenu"
                :class=textDirection
            ...
            >
                <Link href="/" @click="showMenu = !showMenu">
                    <div class="flex items-center gap-3 hover:bg-gray-200 p-2 rounded-lg">
                        <img class="rounded-full ml-1 min-w-[35px] max-h-[35px] cursor-pointer" src="https://picsum.photos/id/140/300/320">
                        <span>{{ user.name }}</span>
                    </div>
                </Link>
                <Link
